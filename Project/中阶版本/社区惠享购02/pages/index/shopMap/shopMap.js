...
Page({
  ...
  //确认选择地址
  selectedOk: function () {
    store.setItem('title',this.data.centerData.title)
    store.setItem('latitude',this.data.centerData.latitude)
    store.setItem('longitude',this.data.centerData.longitude)
    store.setItem('addr',this.data.centerData.addr)
    console.log(this.data.centerData.title)
    wx.switchTab({
